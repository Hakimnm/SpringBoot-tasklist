...
import com.programmingtechie.tasklist.domain.exception.AccessDeniedException;
...
import com.programmingtechie.tasklist.service.props.JwtProperties;
...
public class JwtTokenProvedir {
private final JwtProperties jwtPropeties;
...
@PostConstruct
    public void init() {
    this.key= Keys.hmacShaKeyFor(jwtPropeties.getSecret().getBytes());
}
